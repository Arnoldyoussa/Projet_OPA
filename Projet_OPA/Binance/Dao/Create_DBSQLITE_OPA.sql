...
CREATE TABLE IF NOT EXISTS DIM_TEMPS  ( 
	ID_TEMPS NUMERIC(10) PRIMARY KEY,
	SECONDES VARCHAR(2), 	
	MINUTES VARCHAR(2), 	
	HEURE VARCHAR(2),	
	JOUR VARCHAR(2),	
...
INSERT INTO DIM_ML_CLAS (DESC_MLCLAS,DATE_CREATION) VALUES ( 'ML Classification Achat Paire', DATE('now', 'localtime'));
INSERT INTO DIM_ML_CLAS (DESC_MLCLAS,DATE_CREATION) VALUES ( 'ML Classification Vente Paire', DATE('now', 'localtime') );
